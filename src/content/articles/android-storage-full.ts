...
export const androidStorageFull: Article = {
  ...
  content: {
    tr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            "Detaylarını [Android WhatsApp depolama dolu](/blog/whatsapp-storage-full-android) rehberimizde incelediğimiz gibi, WhatsApp varsayılan olarak aldığınız her fotoğrafı, videoyu, sesli mesajı ve belgeyi telefona indirir ve galeriye kaydeder. Aktif grupların olduğu bir hesapta bu birikim ayda birkaç gigabayta ulaşır. İki yıl sonra WhatsApp klasörü tek başına 15-20 GB olabilir.",
        ...
        },
        {
          ...
          content: [
            ...
            'Android 8 ile birlikte "tüm önbelleği tek seferde temizle" düğmesi sistemden kaldırıldı; artık uygulama uygulama ilerlemek gerekiyor. Detaylar için [Android önbellek temizleme rehberimize](/blog/clear-cache-android) bakabilirsiniz. Disk Mop\'un Android sürümü bu adımı tek ekranda toplar: uygulamaları önbellek boyutuna göre sıralar ve neyin ne kadar yer kapladığını silmeden önce gösterir.',
          ],
        },
        {
          ...
          content: [
            ...
            "Yerelde asıl yeri kaplayanlar genelde fotoğraflar değil videolardır. Bir dakikalık 4K video 350-500 MB tutar; birkaç ekran kaydı ve tatil videosu kolayca birkaç gigabayt eder. Galeri temizliği için [Android'de yinelenen fotoğrafları silme](/blog/delete-duplicate-photos-android) yöntemlerini uygulayabilir veya Disk Mop'un Android sürümüyle benzer fotoğrafları ve ekran görüntülerini tek dokunuşla ayıklayabilirsiniz.",
          ],
        },
      ],
      faq: [
        {
          question:
            "Depolamayı temizleyen uygulamalar telefonu hızlandırır mı?",
          answer:
        ...
        {
          question:
            "Android/data klasörünü dosya yöneticisiyle göremiyorum, neden?",
          answer:
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            "As explained in our guide on [fixing WhatsApp storage full on Android](/blog/whatsapp-storage-full-android), WhatsApp downloads every photo, video, voice message and document you receive and saves it to the gallery. On an account with active groups that accumulates several gigabytes a month. After two years the WhatsApp folder alone can be 15-20 GB.",
        ...
        },
        {
          ...
          content: [
            ...
            'Android 8 removed the system-wide "clear all cached data" button, so today you have to work app by app. For a complete walkthrough, see our guide on [how to clear cache on Android](/blog/clear-cache-android). The Android version of Disk Mop collects this into one screen: it sorts apps by cache size and shows exactly what each one holds before anything is deleted.',
          ],
        },
        {
          ...
          content: [
            ...
            "Locally, the real space usually goes to video rather than photos. One minute of 4K video is 350-500 MB; a few screen recordings and holiday clips easily reach several gigabytes. Screenshots, burst copies of the same moment and blurred frames accumulate too. For targeted photo cleanup, see our guide on [deleting duplicate photos on Android](/blog/delete-duplicate-photos-android), or use Disk Mop to sort and clean them in bulk.",
          ],
        },
      ],
      faq: [
    ...
    fr: {
      title:
        "Stockage Android saturé : qu'est-ce qui prend vraiment la place ?",
      metaDescription:
      ...
      subtitle:
        "Quatre endroits à vérifier avant de supprimer la moindre photo",
      intro: [
      ...
      faq: [
        ...
        {
          question:
            "Pourquoi mon gestionnaire de fichiers ne voit-il pas Android/data ?",
          answer:
        ...
        {
          question:
            "La réinitialisation d'usine est-elle la solution la plus propre ?",
          answer:
    ...
    es: {
      title:
        "Almacenamiento lleno en Android: ¿qué ocupa realmente el espacio?",
      metaDescription:
      ...
      faq: [
        ...
        {
          question:
            "¿Por qué mi gestor de archivos no ve la carpeta Android/data?",
          answer:
    ...
    pt: {
      ...
      faq: [
        ...
        {
          question:
            "Por que meu gerenciador de arquivos não vê a pasta Android/data?",
          answer:
    ...
    ja: {
      ...
      faq: [
        ...
        {
          question:
            "ファイルマネージャーで Android/data フォルダーが見えないのはなぜですか。",
          answer:

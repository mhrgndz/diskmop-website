...
export const iphoneStorageFull: Article = {
  ...
  content: {
    tr: {
      title:
        "iPhone Depolama Alanı Dolu mu? Fotoğraf Silmek Neden Yer Açmadı (ve Ne Açar)",
      metaDescription:
      ...
      subtitle:
        "Son Silinenler, iCloud optimizasyonu ve Sistem Verileri; efsanesiz anlatım",
      intro: [
      ...
      dataTable: {
        caption:
          "Yaygın iPhone medyasının yaklaşık boyutu (video için Apple'ın tahminleri, fotoğraf için tipik değerler)",
      ...
      sections: [
        {
          ...
          content: [
            ...
            "Aşağıdaki tablo Apple'ın kendi tahminlerini kullanıyor. Çıkarılacak sonuç şu: birkaç yüz sıradan fotoğrafı silmek çubuğu nadiren değiştirirken, [iPhone'da video boyutunu küçültme ve sıkıştırma](/blog/reduce-video-size-iphone) adımlarıyla birkaç video ve ekran kaydını optimize etmek birkaç gigabayt açabilir.",
          ],
        },
        {
      ...
      faq: [
        ...
        {
          question:
            "Bir iPhone temizleyici uygulamasının fotoğraflarımı yüklemesi gerekir mi?",
          answer:
    ...
    en: {
      title:
        "iPhone Storage Full? Why Deleting Photos Didn't Free Any Space (and What Does)",
      metaDescription:
      ...
      subtitle:
        "Recently Deleted, iCloud Optimize and System Data, explained without the myths",
      intro: [
      ...
      dataTable: {
        caption:
          "Approximate size of common iPhone media (Apple's estimates for video, typical values for photos)",
      ...
      sections: [
        {
          ...
          content: [
            ...
            "The table below uses Apple's own estimates. As explained in our guide on [how to reduce video size on iPhone](/blog/reduce-video-size-iphone), deleting a few hundred ordinary photos rarely changes the bar, while trimming or compressing large videos and screen recordings can free a couple of gigabytes instantly.",
          ],
        },
        {
    ...
    de: {
      title:
        "iPhone-Speicher voll? Warum das Löschen von Fotos nichts gebracht hat (und was hilft)",
      metaDescription:
      ...
      subtitle:
        "Zuletzt gelöscht, iCloud-Optimierung und Systemdaten, erklärt ohne Mythen",
      intro: [
      ...
      dataTable: {
        caption:
          "Ungefähre Größe gängiger iPhone-Medien (Apples Schätzungen für Video, typische Werte für Fotos)",
      ...
      faq: [
        {
          question:
            "Gibt das Löschen von Fotos auf dem iPhone sofort Speicher frei?",
          answer:
        ...
        {
          question:
            "Werden Fotos, die ich auf dem iPhone lösche, auch aus iCloud gelöscht?",
          answer:
    ...
    fr: {
      title:
        "Stockage iPhone plein ? Pourquoi supprimer des photos n'a rien libéré (et que faire)",
      metaDescription:
      ...
      subtitle:
        "Supprimés récemment, optimisation iCloud et Données système, expliqués sans les mythes",
      intro: [
      ...
      dataTable: {
        caption:
          "Taille approximative des médias iPhone courants (estimations d'Apple pour la vidéo, valeurs typiques pour les photos)",
      ...
      sections: [
        ...
        {
          title:
            "Pourquoi supprimer des photos ne change rien pendant 30 jours",
          content: [
      ...
      faq: [
        {
          question:
            "Supprimer des photos sur iPhone libère-t-il de l'espace immédiatement ?",
          answer:
        ...
        {
          question:
            "Supprimer des photos sur mon iPhone les supprime-t-il d'iCloud ?",
          answer:
        ...
        {
          question:
            "Pourquoi les Données système occupent-elles 20 Go sur mon iPhone ?",
          answer:
        ...
        {
          question:
            "Une app de nettoyage pour iPhone doit-elle envoyer mes photos sur un serveur ?",
          answer:
    ...
    es: {
      title:
        "¿Almacenamiento del iPhone lleno? Por qué borrar fotos no liberó nada (y qué sí)",
      metaDescription:
      ...
      subtitle:
        "Eliminados recientemente, la optimización de iCloud y los Datos del sistema, sin mitos",
      intro: [
      ...
      dataTable: {
        caption:
          "Tamaño aproximado de los archivos habituales del iPhone (estimaciones de Apple para vídeo, valores típicos para fotos)",
    ...
    it: {
      title:
        "Spazio iPhone pieno? Perché eliminare le foto non ha liberato nulla (e cosa funziona)",
      metaDescription:
      ...
      subtitle:
        "Eliminati di recente, ottimizzazione iCloud e Dati di sistema, spiegati senza miti",
      intro: [
      ...
      dataTable: {
        caption:
          "Dimensione approssimativa dei contenuti più comuni su iPhone (stime di Apple per i video, valori tipici per le foto)",
      ...
      faq: [
        ...
        {
          question:
            "Se elimino le foto dal mio iPhone vengono eliminate anche da iCloud?",
          answer:
    ...
    pt: {
      title:
        "Armazenamento do iPhone cheio? Por que apagar fotos não liberou espaço (e o que libera)",
      metaDescription:
      ...
      subtitle:
        "Apagados Recentemente, otimização do iCloud e Dados do Sistema, explicados sem mitos",
      intro: [
      ...
      dataTable: {
        caption:
          "Tamanho aproximado das mídias mais comuns do iPhone (estimativas da Apple para vídeo, valores típicos para fotos)",
      ...
      faq: [
        ...
        {
          question:
            "Um app de limpeza para iPhone precisa enviar minhas fotos para algum lugar?",
          answer:

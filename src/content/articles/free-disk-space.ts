...
export const freeDiskSpace: Article = {
  ...
  content: {
    tr: {
      ...
      intro: [
        'Bilgisayarınızda "Disk alanı yetersiz" uyarısı mı görüyorsunuz? [C diski sebepsiz doluyor](/blog/c-drive-full-for-no-reason) gibi göründüğünde sistem yavaşlar, güncellemeler başarısız olur ve yeni program yükleyemezsiniz. Neyse ki disk temizleme işlemi düşündüğünüz kadar zor değil.',
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            "Windows işletim sistemi, uygulamalar ve tarayıcılar sürekli olarak önbellek (cache) ve [geçici dosyalar](/blog/delete-temporary-files-windows) oluşturur. Sistem güncellemeleri, kurulum dosyaları, Windows Update önbelleği ve uygulama logları zamanla gigabaytlarca disk alanı kaplayabilir. Çoğu kullanıcı bu dosyaların varlığından bile haberdar değildir.",
            "Tarayıcı önbelleği de önemli bir yer kaplayıcıdır. Chrome, Firefox, Edge gibi tarayıcılar ziyaret ettiğiniz sitelerin resim, CSS ve JavaScript dosyalarını yerel diskte saklar. Birden fazla tarayıcı kullanıyorsanız bu dosyalar kolayca 5-10 GB'a ulaşabilir.",
        ...
        },
        {
          ...
          content: [
            ...
            "Windows'ta [yer kaplayan büyük dosyaları bulma](/blog/find-large-files-windows) konusunda Disk Mop'un büyük dosya bulucu özelliği, diskinizi tarayarak 500 MB üzerindeki dosyaları listeler. Dosya türü, boyutu ve son erişim tarihine göre filtreleme yapabilir, gereksiz olanları doğrudan silebilirsiniz. Uzun süredir erişilmemiş büyük dosyalar genellikle güvenle kaldırılabilecek adaylardır.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            "Disk Mop'un boş klasör bulucu özelliği, tüm disk yapınızı tarayarak içi boş klasörleri tespit eder ve toplu olarak silmenizi sağlar. [İndirilenler klasörünü temizleme](/blog/clean-up-downloads-folder) aracı ise Downloads klasörünüzdeki dosyaları tarih ve türe göre analiz ederek eski ve gereksiz indirmeleri belirlemenize yardımcı olur.",
          ],
        },
        {
    ...
    en: {
      ...
      intro: [
        "Running out of disk space is one of the most common and frustrating computer problems. When your [C drive is full for no reason](/blog/c-drive-full-for-no-reason), your system slows down, updates fail to install, and you can't save new files. But don't worry — freeing up disk space is easier than you might think.",
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            "As detailed in our guide to [deleting temporary files on Windows](/blog/delete-temporary-files-windows), your operating system, applications, and web browsers constantly generate cache and temporary files. Windows Update cache, installation leftovers, system logs, and application temp data can quietly accumulate to several gigabytes over time. Most users never realize these files exist.",
        ...
        },
        {
          ...
          content: [
            ...
            "When it comes to [finding large files on Windows](/blog/find-large-files-windows), Disk Mop's large file finder scans your entire disk and lists all files above 500 MB. You can filter by file type, size, and last access date, then delete unnecessary ones directly. Files that haven't been accessed in months are usually safe candidates for removal.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            "Disk Mop's empty folder finder scans your entire disk structure, identifies empty directories, and lets you remove them in bulk. The [downloads cleaner](/blog/clean-up-downloads-folder) analyzes files in your Downloads folder by date and type, helping you identify and remove old, unnecessary downloads efficiently.",
          ],
        },
        {
    ...
    de: {
      ...
      subtitle:
        "6 Schritte zum Aufräumen Ihrer Festplatte, wenn der Speicherplatz knapp wird",
      intro: [
    ...
    fr: {
      ...
      subtitle:
        "6 étapes pour récupérer de l'espace quand votre lecteur C: est plein",
      intro: [
      ...
      sections: [
        ...
        {
          title:
            "5. Nettoyez les dossiers vides et les anciens téléchargements",
          content: [
